...
news organisation (47%), the Israel Hayom news organisation (24%),
...
The named entities IAHLT corpus is a work in progress; this release
consists of 27140 paragraphs from 2970 articles. They have been
annotated with morpheme-level named entity spans.
...
The files consist of JSON dictionaries, one dictionary per line. Each
...
The following entities are present:
